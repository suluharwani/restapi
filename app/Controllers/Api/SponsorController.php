...
class SponsorController extends ResourceController
{
    ...
    public function create()
    {
        ...
        $logo->move(ROOTPATH . 'public/uploads/sponsors', $newName);
    ...
    public function update($id = null)
    {
        ...
        if ($this->request->getFile('logo') !== null) {
            // Delete old logo
            if (file_exists(ROOTPATH . 'public/uploads/sponsors/' . $sponsor['logo'])) {
                unlink(ROOTPATH . 'public/uploads/sponsors/' . $sponsor['logo']);
            }
