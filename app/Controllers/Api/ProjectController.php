...
class ProjectController extends ResourceController
{
    ...
    public function create()
    {
        ...
        $thumbnail->move(ROOTPATH . 'public/uploads/projects', $newName);
    ...
    public function update($id = null)
    {
        ...
        if ($this->request->getFile('thumbnail') !== null) {
            ...
            if (file_exists(ROOTPATH . 'public/uploads/projects/' . $project['thumbnail'])) {
                unlink(ROOTPATH . 'public/uploads/projects/' . $project['thumbnail']);
            }
